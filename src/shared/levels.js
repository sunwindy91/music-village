...
/* 网格作曲的行音高（低→高，C4..G4） */
MV.gridPitches = [60, 62, 64, 65, 67, 69, 71];  // do re mi fa sol la si（七音阶，每个格子都能填不同的音）
...
MV.quizzes = {
  ...
  scale: {
    ...
    questions: [
      ...
      { q: '休息、不出声音的音符，叫？', options: ['休止符', '走路符', '唱歌符'], ans: 0 }
    ]
  },
  meadow: {
    name: '旋律草原 · 乐理小测',
  ...
  rhythm: {
    ...
    questions: [
      ...
      { q: '音乐分成一格一格，叫什么？', options: ['小节', '小河', '小步'], ans: 0 },
      { q: '开头写的「几几拍」，告诉我们？', options: ['每格走几步', '歌有多长', '声音多高'], ans: 0 }
    ]
  },
  chord: {
    name: '和弦花园 · 乐理小测',
