// 晓声 AI 对话代理（Cloudflare Pages Functions）
// LLM key 放 Pages 环境变量（wrangler secret / dashboard），不进仓库不暴露
// 环境变量：DEEPSEEK_API_KEY（必填）· LLM_BASE（默认 https://api.deepseek.com）· LLM_MODEL（默认 deepseek-chat）
