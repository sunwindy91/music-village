...
PROMPTS = [
    ...
    ('xiaosheng_deer', ANCHOR + '，一只温柔发光的小鹿立体形象，Q版3D质感软萌，毛色是晨金与雾绿渐变，'
     ...
     '单一角色全身，纯色底，高级感'),
    # —— 聚类课程架构：聚类封面（水彩场景 + 3D立体晓声混合 · 更出彩） ——
    ('cluster_valley', ANCHOR + '，声音山谷全景，音的高低化作起伏山丘与飞翔的小鸟（高鸟在高岩、低鸟在溪边），'
     '一条发光的寻宝小路通向远方，晨雾与溪水，可爱的3D立体小山灵（Q版软萌，青绿色圆润身体，'
     '头顶一片嫩芽叶，亮晶晶大眼睛）站在小路起点回头向小朋友招手，立体柔光质感与背景水彩完美融合，圆润治愈'),
    ('cluster_scale', ANCHOR + '，山谷中一座彩虹色音阶楼梯（七个彩色台阶向上延伸），'
     '音符像萤火虫沿台阶飘浮，可爱的3D立体小山灵（Q版软萌青绿色）站在楼梯下抬头仰望，圆润治愈'),
    ('cluster_meadow', ANCHOR + '，金色麦田草原，音符种子长成发光的花朵，五线谱化作田垄延伸远方，'
     '可爱的3D立体小山灵（Q版软萌青绿色）在田里种音符，回头笑，圆润治愈'),
    # —— 理论导入卡配图（晓声小课堂） ——
    ...
    ('cluster_rhythm', ANCHOR + '，山谷中的一条节奏小路，脚印与鼓点化作发光圆点排成小路，'
     '大小不同的脚步表现节奏快慢，可爱的3D立体小山灵（Q版软萌青绿色）踩在小路上回头笑，圆润治愈'),
    ('theory_rhythm', ANCHOR + '，三个圆润音符小人排在小路上：一个稳稳走（四分）、一个轻轻跑（八分）、'
     '一个飞快跑（十六分），脚下有发光脚步，圆润可爱'),
    # —— 第5聚类和弦花园：封面 + 理论卡配图 ——
    ('cluster_chord', ANCHOR + '，山谷中的一座花园，三朵发光的花手拉手（代表三和弦），'
     '花朵颜色像彩虹（晨金/雾蓝/森林绿），可爱的3D立体小山灵（Q版软萌青绿色）在花园里轻轻浇水，圆润治愈'),
    ('theory_chord', ANCHOR + '，三个圆润音符小人手拉手站成一圈，脚下有彩虹色光晕，'
     '像好朋友一起唱歌，圆润可爱'),
    # —— 封面焕新 F-08：首页 hero 主视觉（水彩大场景 + 3D立体晓声混合） ——
    ('hero', ANCHOR + '，清晨山谷大远景，晨雾缭绕的五线谱化作起伏山脊，彩色音符像萤火虫在山谷间飞舞，'
     '一条发光的小路从山脚通向山上的木屋学校，画面左下角可爱的3D立体小山灵（Q版软萌，青绿色圆润身体，'
     '头顶一片嫩芽叶，亮晶晶大眼睛）站在路边回头向小朋友招手，立体柔光质感与背景水彩完美融合，高级感治愈'),
]
